      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gestión de lecturas <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="#">Subir lecturas</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="./cgestion_lecturas/descargar_lecturas">Descargar lecturas</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li role="separator" class="divider"></li>
                <li class="dropdown-header">Salir</li>
